...
router.get("/:username", ensureLoggedInAsAdmin, async function (req, res, next) {
  try {
...
router.patch("/:username", ensureLoggedInAsAdmin, async function (req, res, next) {
  try {
...
router.delete("/:username", ensureLoggedInAsAdmin, async function (req, res, next) {
  try {
